...
SOURCES_C = mpi.c comm.c group.c proc.c op.c dtype.c util.c backends/socket/socket_backend.c colls/tuner.c colls/allgather/allgather.c colls/allgatherv/allgatherv.c colls/allreduce/allreduce.c colls/alltoall/alltoall.c colls/bcast/bcast.c colls/gather/gather.c colls/reduce/reduce.c colls/reduce_scatter/reduce_scatter.c colls/scatter/scatter.c
