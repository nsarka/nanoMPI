...
1. First and foremost, nanoMPI is for educational purposes. The vast majority of most MPI libraries are dedicated to performance, which makes them hard to parse as a beginner. nanoMPI allows beginners to distributed computing to quickly answer questions like "how is a tree allreduce implemented?"
2. Development of distributed code on local devices is super convenient! It works offline and doesn't require job scheduling. Part of this project is to allow the authors to develop distributed code and ensure correctness on a local laptop. 
